...
앱이 무엇인지 알고 싶다면 [README](../README.md)를, 왜 이렇게 만들었는지 알고 싶다면 [adr/](./adr/)을 먼저 보세요. 계산이 맞는지 확인하려면 [research/manseryeok-validation.md](./research/manseryeok-validation.md)에 대조한 값과 출처가 있습니다.
